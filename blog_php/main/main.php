            ...
            <section id="section04">
                <div class="section04_wrap">
                    <div class="section04_left">
                        <iframe id="videoIframe" width="100%" height="400px" src="https://www.youtube.com/embed/6kp3_yDFPU8?autoplay=1&mute=1&controls=0&loop=1&playlist=6kp3_yDFPU8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                        <div class="section04_youtube">
                            <div class="youtube_box" onclick="playVideo('https://www.youtube.com/embed/1jfwTPD9O28?autoplay=1&mute=1&controls=0&loop=1&playlist=1jfwTPD9O28')">
                                <p>
                                    <em>신비</em>
                                    10대 교복 아우터 코디
                                </p>
                                <div class="youtube_thum"><img src="../assets/img/sinbe.jpg" alt=""></div>
                                <a href="https://www.youtube.com/watch?v=1jfwTPD9O28" target="_blank"><img src="../assets/img/link_btn.png" alt=""></a>
                            </div>
                            <div class="line"></div>
                            <div class="youtube_box" onclick="playVideo('https://www.youtube.com/embed/zlM9SWT7uYg?autoplay=1&mute=1&controls=0&loop=1&playlist=zlM9SWT7uYg')">
                                <p>
                                    <em>입시덕후</em>
                                    새학기 필수 코디 모음!
                                </p>
                                <div class="youtube_thum"><img src="../assets/img/ipsidokhoo.jpg" alt=""></div>
                                <a href="https://www.youtube.com/watch?v=zlM9SWT7uYg" target="_blank"><img src="../assets/img/link_btn.png" alt=""></a>
                            </div>
                            <div class="line"></div>
                            <div class="youtube_box" onclick="playVideo('https://www.youtube.com/embed/IbVM7gXTtkw?autoplay=1&mute=1&controls=0&loop=1&playlist=IbVM7gXTtkw')">
                                <p>
                                    <em>예보링</em>
                                    SCHOOL LOOK BOOK
                                </p>
                                <div class="youtube_thum"><img src="../assets/img/yeboring.jpg" alt=""></div>
                                <a href="https://www.youtube.com/watch?v=IbVM7gXTtkw" target="_blank"><img src="../assets/img/link_btn.png" alt=""></a>
                            </div>
                        </div>
                    </div>
                    <script>
                    ...
                    <div class="section04_right">
                        ...
                        <div class="media_text">
                            ...
                            <a href="https://www.youtube.com/" target="_blank"><img src="../assets/img/youtube_btn.png" alt=""></a>
                        </div>
                    </div>
                </div>
            </section>
